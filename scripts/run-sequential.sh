#!/bin/bash
# Run humanify in SEQUENTIAL mode on a canonical sample
# Usage: ./scripts/run-sequential.sh <sample-name>
# Example: ./scripts/run-sequential.sh tiny-qs
...
OUTPUT_DIR="$SAMPLE_DIR/output-sequential"
rm -rf "$OUTPUT_DIR"
mkdir -p "$OUTPUT_DIR"

echo "=========================================="
echo "Running SEQUENTIAL mode on: $SAMPLE"
